...
# Path to the Firebase Admin SDK private key
firebase_credentials_path = os.path.join(BASE_DIR, "firebase/firebase-adminsdk.json")
...
ALLOWED_HOSTS = ['reanstartup.pythonanywhere.com','www.reanstartup.com','127.0.0.1']
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'blog/static'),  # Add your app's static directory
]
...
TINYMCE_DEFAULT_CONFIG = {
    'selector': 'textarea.tinymce',  # Add this line
    'height': 360,
    'width': 'auto',
